document.addEventListener("DOMContentLoaded", () => {
    console.log("Starting video preloading process...")

    // Prevent autoplay of lobby video until all videos are loaded
    const lobbyVideo = document.getElementById("lobbyVideo")
    if (lobbyVideo) {
        lobbyVideo.autoplay = false
    }
    ...
    preloader
        .findVideos()
        .setCompleteCallback(() => {
            console.log("Preloading complete! Starting application...")
            initializeApp()
        })
        .startPreloading()
})
